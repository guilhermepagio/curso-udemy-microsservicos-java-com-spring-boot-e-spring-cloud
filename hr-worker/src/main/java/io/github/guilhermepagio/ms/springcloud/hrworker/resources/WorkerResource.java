package io.github.guilhermepagio.ms.springcloud.hrworker.resources;
...
import io.github.guilhermepagio.ms.springcloud.hrworker.repositories.WorkerRepository;
...
public class WorkerResource {
    ...
    public ResponseEntity<Void> configs() {
        logger.info("CONFIG-@VALUE = " + testConfig);
        logger.info("CONFIG-ENVIRONMENT = " + environment.getProperty("test.config"));
